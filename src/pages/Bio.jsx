...
const Bio = () => {
    ...
    <p className="background_text p-5 bg-[#f5f5f5] rounded-[50px] mb-5 mx-[5px]">
      Je m'appelle Yrieix Cisterne. J'ai 18 ans. Je suis étudiant en première année de Bachelor Chef de Projets Digitaux.
    ...
    Je m'intéresse au développement web. J'apprends tous les jours HTML et CSS, ainsi que le React et TailwindCSS.
     ...
     Je veux m'impliquer dans des projets stimulants. Je suis toujours prêt à relever de nouveaux défis. Mon but est de contribuer à des projets.
        ...
        <p className="background_text p-5 bg-[#f5f5f5] rounded-[50px] mx-[5px]">
        Je suis actuellement en recherche d'un stage alterné de deux mois en développement web du 10 mars aux 20 juin 2025, 
