...
const Charte = () => {
    return (
        <div style={{ fontFamily: 'Roboto'}} className="min-h-screen bg-fond font-sans flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-blanc rounded-lg shadow-lg mx-6 w-full max-w-4xl mt-6">
            ...
            <div className="p-6 bg-blanc rounded-lg shadow-lg mx-6 w-full max-w-4xl mt-6">
            ...
            <Titre title={"Les interdits du log:"}/>
            <div className="p-6 bg-blanc rounded-lg shadow-lg mx-6 w-full max-w-4xl mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                <div className="bg-fond"><img src="/charte/logoycno_bg.png" alt="Interdit logo sans fond"></img><p>Interdiction de ne pas avoir de fond</p></div>
