...
const CV = () => {
  return (
    <div style={{ fontFamily: 'Roboto'}} className="min-h-screen bg-gray-300 font-sans flex flex-col justify-center items-center p-4 lg:flex-row lg:items-start lg:gap-8">
      ...
      <div className="absolute top-36"><a href="/cv.pdf" download="CV Yrieix Cisterne" className="w-full bg-gray-700 text-white py-4 text-center font-bold text-2xl rounded-lg my-6 z-0">Télécharger mon CV</a></div>
